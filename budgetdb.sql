...
COPY public.category (id, name, initialfunds, currentfunds, priority, userid) FROM stdin;
\.
...
COPY public.transaction (id, amount, date, notes, userid, category_id) FROM stdin;
\.
...
2	nickverrilli@gmail.com	88204	Nick	Verrilli
\.
